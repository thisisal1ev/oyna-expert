      ...
      <div className="w-full max-w-base mx-auto px-5">
        <div>
          ...
          <div className="text-textGrey font-montserrat">
            <p className="text-base leading-normal mb-4 lg:mb-6 md:text-lg">{detailBalconies.mainText}</p>
            <p className="text-base leading-normal mb-4 lg:mb-6 md:text-lg">{detailBalconies.context}</p>
            <h3 className="text-base pt-4 mb-4 lg:mb-6 md:text-lg">{detailBalconies.sectionTitle}</h3>
