  ...
  return (
    <div className='py-9'>
      <div className="w-full max-w-base mx-auto px-5">
        <h1 className='mb-6 font-extrabold text-22 sm:text-2xl md:3xl lg:text-4xl xl:text-5xl sm:mb-8 lg:mb-9 xl:mb-11'>Xizmat ko'rsatish</h1>
        <div className='font-montserrat text-textGrey mb-6 space-y-4 lg:mb-8 lg:space-y-6'>
          ...
          <h2 className='font-bold text-2xl sm:text-26 md:text-3xl lg:text-32 xl:text-4xl'>Deraza ishlab chiqarish vaqtlari:</h2>
          <ul className='list-disc ml-4'>
            <li className="md:text-lg">Eshik va derazalarni ishlab chiqarish - 5 kun</li>
            <li className="md:text-lg">Yetkazib berish - 1 kun ichida</li>
            <li className="md:text-lg">Eski eshik yoki derazani olib tashlash, o'rnatish va tugatish ishlari - 1 kun</li>
          </ul>
