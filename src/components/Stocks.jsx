  ...
  return (
    <div className='py-9'>
      <div className="w-full max-w-base mx-auto px-5">
        <h2 className='mb-6 font-extrabold text-22 sm:text-2xl md:3xl lg:text-4xl xl:text-44 sm:mb-8 lg:mb-9 xl:mb-11' data-aos="fade-up" data-aos-anchor-placement="center" data-aos-easing="ease-in" data-aos-duration="800">Aksiyalar va derazalar uchun chegirmalar</h2>
          ...
          <div className='rounded-xl'>
            <Link to='/' className='inline-block relative z-1 overflow-hidden rounded-xl'>
              <div className='bg-koshka bg-cover bg-no-repeat hover:scale-105 transition-all duration-700'>
                <div className='text-white bg-img w-full'>
                  <div className='flex flex-col space-y-4 px-10 py-10 sm:px-11 sm:py-12 md:py-20 lg:px-5 xl:pr-28 xl:pl-10 xl:pt-36 xl:pb-8' data-aos="fade-up" data-aos-anchor-placement="bottom" data-aos-easing="ease-in" data-aos-duration="800">
