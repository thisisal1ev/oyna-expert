  ...
  return (
    <div className='py-9'>
      <div className="w-full max-w-base mx-auto px-5">
        ...
        <form className='border px-5 py-8 rounded-md font-montserrat text-textGrey flex flex-col md:flex-row md:items-center' action="#">
          <div className='space-y-3 text-sm mb-10 md:mb-0 md:mr-[10%] w-full'>
            <label className='flex flex-col space-y-2 font-bold'>
              E-mail:
              <input className='border p-2 outline-none rounded-md text-mainBlack font-normal focus:border-mainBlack' type="email" placeholder='example@gmail.com' />
            </label>
            <label className='flex flex-col space-y-2 font-bold'>
              Parol:
              <a href="#" className='inline-block text-primaryBlue hover:underline font-normal'>Parollingizni unuttingizmi?</a>
              <input className='border p-2 outline-none rounded-md text-mainBlack font-normal focus:border-mainBlack' type="password" placeholder='********' />
            </label>
