          ...
          <div className='space-y-5 mb-5 lg:mb-0'>
            <div className='space-y-2'>
              ...
              <div className='flex items-center justify-center sm:justify-normal space-x-2'>
                <a href='#' className='font-semibold text-mainGrey hover:text-mainBlack transition-all duration-500'>WhatsApp</a>
                <a href='https://t.me/thisisal1ev' target='_blank' className='font-semibold text-mainGrey hover:text-mainBlack transition-all duration-500'>Telegram</a>
              </div>
            </div>
            <div className='space-y-2'>
          ...
          <div className='space-y-5'>
            <div className='space-y-2'>
              ...
              <div className='flex items-center justify-center space-x-3 sm:justify-normal'>
                <a href='#' className='opacity-50 hover:opacity-100 transition-all duration-500'>
                ...
                <a href='https://t.me/thisisal1ev' target='_blank' className='opacity-50 hover:opacity-100 transition-all duration-500'>
        ...
        <div className='w-full mx-auto max-w-base px-5'>
          ...
          <div className='flex items-start justify-center sm:justify-normal'>
            <div className='flex items-center py-2 space-x-5 mb-3'>
              <a href='#' className='grayscale hover:grayscale-0 transition-all duration-500'>
      ...
      <div className='py-8'>
        <div className='w-full mx-auto max-w-base px-5'>
          <div className="w-full max-w-base mx-auto px-5 flex items-center flex-col justify-between sm:flex-row">
            ...
            <p className='font-medium font-montserrat text-sm'>Qo&apos;llab-quvvatlash. <a href='https://t.me/thisisal1ev' target='_blank' className='underline'>thisisa1ev veb-saytlarni ishlab chiqish.</a></p>
          </div>
        </div>
      </div>
