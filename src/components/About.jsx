  ...
  return (
    <div className='py-9'>
      <div className="w-full max-w-base mx-auto px-5">
        ...
        <Link className='inline-block font-montserrat font-semibold text-base underline underline-offset-8 opacity-70 transition-all duration-300 hover:no-underline hover:opacity-100'>Batafsil</Link>
      </div>
    </div>  )
}
