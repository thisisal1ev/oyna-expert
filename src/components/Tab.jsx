    ...
    <div className="py-9">
      ...
      <div className="w-full max-w-base mx-auto px-5">
        ...
        <div className="mb-6" data-aos="fade-up">
          ...
          <h3 className="text-sm font-medium font-montserrat text-textGrey sm:text-base">Ishlab chiqarish muddati faqat 5 kun</h3>
        </div>
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <Link to={`/plastik oynalar/${tab.tabContentTitle}`} className="inline-block mb-6">
                ...
                <div>
                  ...
                  <Link to={`/plastik oynalar/${tab.tabContentTitle2}`} className="inline-block mb-6">
                    <h4 className="mb-2 text-22 font-bold md:text-2xl lg:text-28">{tab.tabContentTitle2}</h4>
                    <p className="font-medium text-base  whitespace-nowrap">{tab.tabContent2}</p>
                  </Link>
                ...
                <div>
                  ...
                  <Link to={`/plastik oynalar/${tab.tabContentTitle3}`} className="inline-block mb-6">
                    <h4 className="mb-2 text-22 font-bold md:text-2xl lg:text-28">{tab.tabContentTitle3}</h4>
                    <p className="font-medium text-base whitespace-nowrap">{tab.tabContent3}</p>
                  </Link>
