  ...
  return (
    <>
      ...
      <div className='py-9'>
        <div className="w-full max-w-base mx-auto px-5">
          <div className='mb-5'>
            <h2>Yaxshi derazalar uchun-yaxshi xizmat!</h2>
            <h3>Biz sifatni kafolatlaymiz, chunki bizning derazalarimiz sizning qulayligingiz uchun yaratilgan</h3>
          </div>
          <ul className='grid grid-cols-1 md:grid-cols-2'>
            {
              service.map((servic) => {
                return (
                  <li key={servic.id}>
                    <img src={servic.img} alt={servic.title} />
                    <h4>{servic.title}</h4>
                    <p>{servic.context}</p>
                  </li>
                )
