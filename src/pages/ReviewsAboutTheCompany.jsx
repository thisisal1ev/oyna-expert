  ...
  return (
    <div className='py-3%'>
      ...
      <div className="content-container">
              ...
              return (
                <li key={review.id} className='flex flex-col h-auto'>
                  ...
                  <div className='bg-grey grow relative rounded-xl p-[7%] mb-6 sm:mb-8 lg:mb-9'>
                    ...
                    <p className='font-montserrat relative z-1 text-sm grow text-mainBlack'>{review.reviewContext}</p>
        ...
        <div className='py-6'>
          <button className='text-white text-lg bg-primaryBlue font-montserrat py-2 px-5 rounded-md w-full hover:opacity-70 transition-all duration-300 md:w-auto'>Sharx qoldirish</button>
        </div>
