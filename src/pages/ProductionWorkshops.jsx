...
const ProductionWorkshops = () => {
  const filteredNews = newsData.filter((obj) => obj.uniqueName === `ishlab chiqarish`);
  ...
  return (
    <div className='py-9'>
      ...
      <div className="content-container">
        ...
        <h1 className='mb-6 font-extrabold text-22 sm:text-2xl md:3xl lg:text-4xl xl:text-5xl sm:mb-8 lg:mb-9 xl:mb-11'>Ishlab chiqarish</h1>
