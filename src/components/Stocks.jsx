  ...
  return (
    <div className='py-9'>
      ...
      <div className="w-full max-w-base mx-auto px-5">
        ...
        <h2 className='mb-6 font-extrabold text-22 sm:text-2xl md:text-3xl lg:text-4xl xl:text-44 sm:mb-8 lg:mb-9 xl:mb-11' data-aos="fade-up" data-aos-anchor-placement="center" data-aos-easing="ease-in" data-aos-duration="800">Aksiyalar va derazalar uchun chegirmalar</h2>
