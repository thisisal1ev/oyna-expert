        ...
        <div className='flex-col items-center text-center w-full mx-auto max-w-base px-5 flex sm:items-start sm:text-left lg:flex-row lg:items-center justify-between mb-5'>
          ...
          <div className='space-y-5 mb-5 lg:mb-0'>
            ...
            <div className='space-y-2'>
              ...
              <Link to='https://aaalievvv1@gmail.com' target='_blank' className='font-semibold text-lg text-lightGreen underline underline-offset-1 hover:no-underline'>aaalievvv1@gmail.com
              </Link>
            </div>
          </div>
          <div className='space-y-5'>
            <div className='space-y-2'>
              ...
              <div className='flex items-center justify-center space-x-3 sm:justify-normal'>
                ...
                <Link to='https://t.me/thisisal1ev' target='_blank' className='opacity-50 hover:opacity-100 transition-all duration-500'>
